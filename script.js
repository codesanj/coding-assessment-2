function fetchData() {
    ...
    fetch(apiUrl)
      ...
      .then((data) => {
        ...
        document.getElementById("main-product-image").src ="./images/1.png"
        // quality of images not good as links were not working so screenshotted images have been used
        ...
        const thumbnailFileNames = ["1.png", "2.png", "3.png", "1.png"];
